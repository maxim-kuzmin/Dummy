namespace Makc.Dummy.MicroserviceReaderViaNoSQL.Apps.WebApp.App;
...
public static class AppExtensions
{
  ...
  public static WebApplication BuildApp(this WebApplicationBuilder appBuilder, ILogger logger)
  {
    ...
    services
      .AddAppIntegrationMicroserviceReaderViaNoSQLInfrastructureTiedToGrpcServer(logger)
  ...
  public static WebApplication UseApp(this WebApplication app, ILogger logger)
  {
    ...
    app.UseAppIntegrationMicroserviceReaderViaNoSQLInfrastructureTiedToGrpcServer(logger);
