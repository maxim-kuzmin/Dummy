namespace Makc.Dummy.MicroserviceReaderViaNoSQL.Domain.UseCases.AppInbox;
  ...
  public static AppIncomingEventSaveCommand ToAppIncomingEventUpdateCommand(this AppIncomingEventSingleDTO dto)
  {
    return new(
      ...
      Data: new(
        ...
        LastProcessingAt: dto.LastProcessingAt,
        LastProcessingError: dto.LastProcessingError,
