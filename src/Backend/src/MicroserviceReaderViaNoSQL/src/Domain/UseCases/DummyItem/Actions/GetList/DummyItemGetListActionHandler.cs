namespace Makc.Dummy.MicroserviceReaderViaNoSQL.Domain.UseCases.DummyItem.Actions.GetList;
...
public class DummyItemGetListActionHandler(
  ...
  IDummyItemQueryService _service) : IRequestHandler<DummyItemGetListActionRequest, Result<List<DummyItemSingleDTO>>>
{
  /// <inheritdoc/>
  public async ValueTask<Result<List<DummyItemSingleDTO>>> Handle(
