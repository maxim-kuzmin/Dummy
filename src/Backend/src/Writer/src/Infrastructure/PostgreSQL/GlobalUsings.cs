...
global using Makc.Dummy.Writer.Infrastructure.PostgreSQL.DummyItem.Actions.Get;
global using Makc.Dummy.Writer.Infrastructure.PostgreSQL.DummyItem.Actions.GetList;
