namespace Makc.Dummy.Writer.Apps.WebApp.AppOutgoingEventPayload.Endpoints.Delete;
  ...
  Endpoint<AppOutgoingEventPayloadDeleteActionCommand, AppOutgoingEventPayloadSingleDTO>
{
  ...
  /// <inheritdoc/>
  public override async Task HandleAsync(AppOutgoingEventPayloadDeleteActionCommand request, CancellationToken cancellationToken)
  {
