namespace Makc.Dummy.Integration.MicroserviceWriter.Infrastructure.GrpcServer.App;
...
public static class AppExtensions
{
  ...
  public static WebApplication UseAppIntegrationMicroserviceWriterInfrastructureTiedToGrpcServer(
