namespace Makc.Dummy.Integration.MicroserviceReaderViaNoSQL.Infrastructure.HttpClient.AppIncomingEvent.Services;
  ...
  IHttpClientFactory _httpClientFactory) : IAppIncomingEventQueryService
{
    ...
    CancellationToken cancellationToken)
  {
    ...
    var resultTask = httpResponse.ToResultFromJsonAsync<List<AppIncomingEventSingleDTO>>(cancellationToken);
