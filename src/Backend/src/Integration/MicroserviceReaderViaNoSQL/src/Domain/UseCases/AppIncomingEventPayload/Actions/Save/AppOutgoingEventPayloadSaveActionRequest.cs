namespace Makc.Dummy.Integration.MicroserviceReaderViaNoSQL.Domain.UseCases.AppIncomingEventPayload.Actions.Save;
...
public record AppIncomingEventPayloadSaveActionCommand(AppIncomingEventPayloadSaveCommand Command) :
  IRequest<Result<AppIncomingEventPayloadSingleDTO>>;
