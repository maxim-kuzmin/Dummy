namespace Makc.Dummy.Integration.MicroserviceWriterViaSQL.Infrastructure.HttpClient.App;
...
public static class AppExtensions
{
  ...
  public static IServiceCollection AddAppIntegrationMicroserviceWriterViaSQLInfrastructureTiedToHttpClient(
