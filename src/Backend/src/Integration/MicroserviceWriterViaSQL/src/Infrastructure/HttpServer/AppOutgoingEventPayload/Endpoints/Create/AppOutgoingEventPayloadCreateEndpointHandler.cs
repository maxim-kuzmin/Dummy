namespace Makc.Dummy.Integration.MicroserviceWriterViaSQL.Infrastructure.HttpServer.AppOutgoingEventPayload.Endpoints.Create;
  ...
  Endpoint<AppOutgoingEventPayloadCreateEndpointRequest, long>
{
    ...
    CancellationToken cancellationToken)
  {
    ...
    await Send.ResultAsync(result.ToMinimalApiResult()).ConfigureAwait(false);
  }
}
