namespace Makc.Dummy.Integration.MicroserviceWriterViaSQL.Infrastructure.GrpcServer.DummyItem;
...
public class DummyItemService(IMediator _mediator) : DummyItemServiceBase
{
  ...
  /// <param name="context">Контекст.</param>
  /// <returns>Отклик gRPC.</returns>
  public override async Task<DummyItemGetGrpcReply> Get(DummyItemGetGrpcRequest request, ServerCallContext context)
  {
