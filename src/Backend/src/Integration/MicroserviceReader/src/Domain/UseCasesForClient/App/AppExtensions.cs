namespace Makc.Dummy.Integration.MicroserviceReader.Domain.UseCasesForClient.App;
...
public static class AppExtensions
{
  ...
  public static IServiceCollection AddAppIntegrationMicroserviceReaderDomainUseCasesForClient(
