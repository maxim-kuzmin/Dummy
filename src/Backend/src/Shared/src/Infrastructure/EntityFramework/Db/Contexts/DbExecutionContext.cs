...
public class DbExecutionContext : IDbExecutionContext
{
  ...
  public DbExecutionContext(DbContext dbContext)
  {
  ...
  /// <inheritdoc/>
  public IDbExecutionContext WithIsolationLevel(IsolationLevel isolationLevel)
  {
  ...
  /// <inheritdoc/>
  public IDbExecutionContext WithSaveChanges()
  {
