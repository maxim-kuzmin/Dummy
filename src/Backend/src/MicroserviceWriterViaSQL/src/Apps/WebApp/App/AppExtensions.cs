namespace Makc.Dummy.MicroserviceWriterViaSQL.Apps.WebApp.App;
...
public static class AppExtensions
{
  ...
  public static WebApplication BuildApp(this WebApplicationBuilder appBuilder, ILogger logger)
  {
    ...
    services
      ...
      .AddAppIntegrationMicroserviceWriterViaSQLInfrastructureTiedToGrpcServer(logger)
  ...
  public static WebApplication UseApp(this WebApplication app, ILogger logger)
  {
    ...
    app.UseAppIntegrationMicroserviceWriterViaSQLInfrastructureTiedToGrpcServer(logger);
