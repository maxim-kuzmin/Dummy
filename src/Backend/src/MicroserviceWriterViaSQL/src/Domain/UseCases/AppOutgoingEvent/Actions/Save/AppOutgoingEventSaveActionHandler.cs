namespace Makc.Dummy.MicroserviceWriterViaSQL.Domain.UseCases.AppOutgoingEvent.Actions.Save;
...
{
  /// <inheritdoc/>
  public async ValueTask<Result<AppOutgoingEventSingleDTO>> Handle(
