namespace Makc.Dummy.MicroserviceWriterViaSQL.Domain.UseCases.AppOutgoingEvent.Actions.GetPage;
...
{
  /// <inheritdoc/>
  public async ValueTask<Result<AppOutgoingEventPageDTO>> Handle(
